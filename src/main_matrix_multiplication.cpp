...
int main(int argc, char **argv)
{
...

    {
        ...
        for (int iter = 0; iter < benchmarkingIters; ++iter) {
            ...
            unsigned int global_work_size1 = (N + work_group_size - 1) / work_group_size * work_group_size;
            unsigned int global_work_size2 = (M + work_group_size - 1) / work_group_size * work_group_size;
            matrix_multiplication_kernel.exec(gpu::WorkSize(work_group_size, work_group_size, global_work_size1, global_work_size2), as_gpu, bs_gpu, cs_gpu, M, K, N);
